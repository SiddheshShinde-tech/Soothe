        ...
        <div className="container-fluid d-flex justify-content-center">
          <div className="row">
            ...
            <div className="col-md-4">
              <CardUi
                imgsrc={therapy}
                title="Free & Paid Therapies"
                description="Experience the Digital Psychotherapies we provide."
              ></CardUi>
            </div>
            <div className="col-md-4">
              <CardUi
                imgsrc={game}
                title="Games & Fun"
                description="Relax your mind with interesting games. Enjoy!"
              ></CardUi>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <CardUi
                ...
                description="Meet our expert Doctors and experience the change. Click here to know more. "
              ></CardUi>
            </div>
          </div>
        </div>
